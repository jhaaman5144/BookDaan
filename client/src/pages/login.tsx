        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Simple steps to start sharing knowledge
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Share your favorite books with others. Add them to our
                  platform and help build a community library.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Browse available books and connect with donors. Request books
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Give books a second life instead of throwing them away. Help
                  create a sustainable reading ecosystem.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400">
              © 2025 BookDaan. Made with ❤️ for book lovers.
            </div>
          </div>
        </div>
      </footer>
